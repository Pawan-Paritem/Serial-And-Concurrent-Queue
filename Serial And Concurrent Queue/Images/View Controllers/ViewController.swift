...
final class ViewController: UIViewController {
    ...
    private func download(using dispatchQueue: DispatchQueue) {
        ...
        let url1 = URL(string: "https://c4.wallpaperflare.com/wallpaper/18/949/253/pakistan-monument-museum-islamabad-wallpaper-preview.jpg")
        let url2 = URL(string: "https://c4.wallpaperflare.com/wallpaper/301/737/212/monuments-pakistan-monument-islamabad-monument-wallpaper-preview.jpg")
